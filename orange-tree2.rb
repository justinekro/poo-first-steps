...
# ======================== On crée des instances de classe pour tester ===================================

verger_prod_annuelle = Array.new 

tree = Orange_tree.new(8)
# 10.times do 
tree.one_year_passes
verger_prod_annuelle << tree.orange

# end

tree2 = Orange_tree.new(2)
10.times do tree2.one_year_passes
end


# age de chaque arbre + 20 - nombre de fruits ramassés
puts tree.orange
